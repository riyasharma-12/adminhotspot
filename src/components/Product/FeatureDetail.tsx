...
// import { Image, List, Drawer, Form, Input, Upload, Button, message } from "antd";
...
//     } catch (err: any) {
//       message.error(err?.response?.data?.message || "Failed to add feature");
//     } finally {
//       hide();
//     }
//   };
...
//         <Button type="primary" icon={<Plus size={16} />} onClick={() => setDrawerVisible(true)}>
//           Add Feature
//         </Button>
//       </div>
...
//       >
//         <Form layout="vertical" form={featureForm} onFinish={addFeature}>
//           <Form.Item
//             name="title"
//             label="Feature Title"
